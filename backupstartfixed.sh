...
restorewd(){
    cd /var/www/pterodactyl && php artisan down && cd /var/www/ && tar -xzvf backup.tar.gz -C /var/www && cd /var/www/../.. && cd /var/www/pterodactyl && php artisan up && cd /var/www/pterodactyl/../../.. || exit
}

backupwod(){
    cd /var/www/pterodactyl && cd /var/www/ && tar -czvf backup.tar.gz /var/www/pterodactyl && cd /var/www/pterodactyl && cd /var/www/pterodactyl/../../.. || exit
}

restorewod(){
    cd /var/www/pterodactyl && cd /var/www/ && tar -xzvf backup.tar.gz -C /var/www && cd /var/www/../.. && cd /var/www/pterodactyl && cd /var/www/pterodactyl/../../.. || exit
}
